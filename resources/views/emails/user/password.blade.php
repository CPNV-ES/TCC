...
@section('content')
    ...
    Veuillez procéder au choix du mot de passe via le lien suivant : <a href="{{$_SERVER['SERVER_NAME']}}/password/create{{ $urlCondition }}"> {{$_SERVER['SERVER_NAME']}}/password/create{{ $urlCondition }} </a><br/><br/>
