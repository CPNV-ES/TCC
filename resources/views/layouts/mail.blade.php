    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#eff3f8">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                    ...
                    <tr><td bgcolor="#ffffff">
                            ...
                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #57697e;padding-left:10px">@yield('logo')</p>
                            <!-- padding --><div style="height: 20px; line-height: 50px; font-size: 10px;"> </div>
                        </td></tr>
                    <!--header END-->
                            ...
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td align="center">
                                        ...
                                        <div style="line-height: 44px;">
                                            <font face="Arial, Helvetica, sans-serif" size="5" color="#CCCCCC" style="font-size: 34px;">
                                ...
                                <tr><td align="center">
                                        ...
                                        <div class="mob_100" style="float: left; display: inline-block; width: 100%;">
                                            <table class="mob_100" width="100%" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse: collapse;">
                                                <tr><td style="line-height: 14px; padding: 0 27px;">
                                                        <div style="line-height: 21px;">
                                                            <font face="Arial, Helvetica, sans-serif" size="3" color="#98a7b9" style="font-size: 14px;">
								<span style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #57697e;padding:10px">
									@yield('content')
								</span></font>
                                                        </div>
                                                    </td></tr>
